...
class ScalarMetric(Metric):
    def __init__(self, args: argparse):
        ...
        super(ScalarMetric, self).__init__(args)
...
class MI(ScalarMetric):
    def __init__(self, args: argparse):
        self.name = 'Mutual information'
        super(MI, self).__init__(args)
...
class CondEnt(ScalarMetric):
    def __init__(self, args: argparse):
        self.name = 'Conditional Entropy'
        super(CondEnt, self).__init__(args)
...
class MargEnt(ScalarMetric):
    def __init__(self, args: argparse):
        self.name = 'Marginal Entropy'
        super(MargEnt, self).__init__(args)
...
class LaplacianEnergy(ScalarMetric):
    def __init__(self, args: argparse):
        self.name = 'Laplacian Energy'
        super(LaplacianEnergy, self).__init__(args)
...
class MaxEigS(ScalarMetric):
    def __init__(self, args: argparse):
        self.name = 'Max Eig S'
        super(MaxEigS, self).__init__(args)
...
class MaxEigQ(ScalarMetric):
    def __init__(self, args: argparse):
        self.name = 'Max Eig Q'
        super(MaxEigQ, self).__init__(args)
...
class ConfMatrix(Metric):
    def __init__(self, args: argparse):
        ...
        super(ConfMatrix, self).__init__(args)
