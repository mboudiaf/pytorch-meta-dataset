...
class ImageDecoder(object):
  ...
  #   base_size = int(self.image_size * 256 / 224)
  #   reshape_size = [base_size, base_size]
  #   image_resized = resize_(
  #       image_decoded,
  #       reshape_size,
  #       preserve_aspect_ratio=True,
  #       method=ResizeMethod.BILINEAR,
  #       )
  #   image_resized = tf.image.resize_with_crop_or_pad(image_resized, self.image_size, self.image_size)
